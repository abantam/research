...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/unsaved_onchip_memory2_0.v" -work onchip_memory2_0 -cdslib ./cds_libs/onchip_memory2_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/unsaved.v"                                                                                               
fi
